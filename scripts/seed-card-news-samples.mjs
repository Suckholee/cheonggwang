...
const SAMPLES = [
  {
    ...
    bodyMarkdown: [
      "**강남역 도보 5분, 협업 공간 찾으세요?** 출퇴근하기 편한 위치에서 진짜 일에 집중할 수 있는 공간을 찾고 있다면 주목하세요.",
      "@@SLIDE@@",
      "1인 전용석부터 8인 미팅룸까지, 다양한 인원과 업무 스타일에 맞는 좌석을 갖추고 있어요. 월 25만원부터 시작합니다.",
      "@@SLIDE@@",
      "24시간 지문 보안 출입으로 야근도 새벽 출근도 자유롭게. 입주사 50곳 이상이 활동하는 안전한 비즈니스 환경입니다.",
      "@@SLIDE@@",
      "무제한 커피·차·간식이 라운지에 항상 준비되어 있습니다. 카페 결제 없이 집중할 수 있어 많은 입주사가 만족하고 있어요.",
      "@@SLIDE@@",
      "매주 화요일 입주사 네트워킹 행사로 새로운 협업과 기회를 만나보세요. 단순 사무실이 아닌 비즈니스 커뮤니티입니다.",
      "@@SLIDE@@",
      "지금 투어 신청하면 첫 달 30% 할인. 강남 코워킹스페이스에서 새로운 일터를 시작하세요.",
    ].join("\n"),
  ...
  },
  {
    ...
    bodyMarkdown: [
      "**눈 건강, 30년 경력에 맡겨보세요.** 강서구 화곡동에서 2대째 운영 중인 가족 안경원입니다.",
      "@@SLIDE@@",
      "정밀 시력 검사부터 얼굴형 맞춤 프레임 추천까지, 모든 과정을 사장님이 직접 진행합니다.",
      "@@SLIDE@@",
      "명품 브랜드부터 합리적 가격대 국산까지 800종 이상 보유. 다양한 선택지에서 나에게 꼭 맞는 안경을 찾을 수 있어요.",
      "@@SLIDE@@",
      "블루라이트 차단 렌즈, 다초점 렌즈, 도수 선글라스 등 전문 영역도 강점. 검안 의자와 자동 굴절 측정기로 정밀 검사를 제공합니다.",
      "@@SLIDE@@",
      "당일 제작 가능. 급하게 안경이 필요한 출장 중 손님도 안심하고 방문하세요.",
      "@@SLIDE@@",
      "보청기 상담도 함께 진행해 어르신 단골 손님이 많아요. 가족 모두의 눈·귀 건강을 한 번에 챙기세요.",
    ].join("\n"),
  ...
  },
  {
    ...
    bodyMarkdown: [
      "**반려동물 응급, 새벽에도 안심하세요.** 사당역 도보 3분 거리 24시간 응급실을 운영하는 종합 동물병원입니다.",
      "@@SLIDE@@",
      "강아지·고양이 일반 진료부터 외과 수술, 치과, 피부과, 심장 초음파까지 전문 분야를 아우릅니다.",
      "@@SLIDE@@",
      "5년간 누적 진료 사례 12,000건 이상. 풍부한 임상 경험으로 정확한 진단과 치료를 제공합니다.",
      "@@SLIDE@@",
      "따뜻한 분위기의 대기실과 반려동물 친화적 진료실. 보호자와 아이 모두 편안한 분위기를 만듭니다.",
      "@@SLIDE@@",
      "정기 검진 패키지로 미리 예방하세요. 조기 발견이 가장 좋은 치료입니다.",
      "@@SLIDE@@",
      "야간 응급 진료 가능. 사당역 3번 출구 도보 3분, 해피펫 동물병원에서 우리 아이 건강 지키세요.",
    ].join("\n"),
...
async function seedOne(s) {
  ...
  if (existing.exists) {
    console.log(`  ⊙ posts/${s.postId} already exists, skip`);
    return;
  }
