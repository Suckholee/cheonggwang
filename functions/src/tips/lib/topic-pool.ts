...
/**
 * v1.17 cycle #30 cleaning-tips-content · §3.5 functions side mirror.
 *
 * ⚠️ MIRROR of src/lib/tips/topic-pool.ts — keep in sync.
 *    CI lint: scripts/check-queue-mirror.mjs (TIPS_TOPIC_POOL 양 패키지).
 */
